<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('categories.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md shadow-sm text-sm transition-colors">
                + Tambah Kategori
            </a>
        </div>
    </x-slot>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat kategori produk pertama Anda.</p>
                                <div class="mt-6">
