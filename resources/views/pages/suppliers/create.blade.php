        ...
        <div class="p-6">
            <form action="{{ route('suppliers.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="pic_name" value="{{ old('pic_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                </div>
