<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed sm:relative inset-y-0 left-0 z-30 w-64 bg-slate-900 text-slate-300 flex flex-col transition-transform duration-300 ease-in-out sm:translate-x-0 h-full shadow-lg">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 px-4 mt-6">POS (Kasir) & Penjualan</div>
        ...
        <div class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 px-4 mt-6">Inventory & Pembelian</div>
        ...
        @role('superadmin|admin_cabang')
        <div class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 px-4 mt-6">Keuangan (Finance)</div>
        ...
        @role('superadmin|admin_cabang')
        <div class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 px-4 mt-6">Master Data</div>
        ...
        @endrole
        @role('superadmin|admin_cabang')
        <div class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 px-4 mt-6">Laporan & Analitik</div>
        ...
        @role('superadmin')
        <div class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2 px-4 mt-6">Pengaturan Enterprise</div>
